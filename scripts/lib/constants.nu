export const YUBIKEY_PUB = path self | path join .. .. .. src secrets yubikey yubikey_identity_usbc.pub | path expand
export const BOOTSTRAP_HOSTNAME = "bootstrap.local"
export const PROJECT_ROOT = path self | path join .. .. .. | path expand
export const HOSTS_DIR = $PROJECT_ROOT | path join src hosts nixos | path expand
